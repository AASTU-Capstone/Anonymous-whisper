...
namespace ComplaintSystem.Application.Persistence.Contracts
{
    public interface IComplaintRepository : IGenericRepository<Complaint>
    {
        ...
        public Task<List<Complaint>> GetMatchingComplaints(string Keyword,string status, string category, string dateOrder, PaginationDto paginationDto);
        ...
        public Task<int> GetMatchingComplaintsCount(string Keyword,string status, string category);
